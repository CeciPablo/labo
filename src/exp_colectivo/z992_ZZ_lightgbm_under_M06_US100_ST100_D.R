...
PARAM  <- list()
PARAM$experimento  <- "COLECTIVO/ZZ9420_M06_US100_ST100_D"
PARAM$exp_input  <- "COLECTIVO/HT9420_M06_US100_ST100"
PARAM$submit <- "ZZ9420_M06_US100_ST100_D"
...
#  cortes1  <- seq( from=  8000,
#                   to=   9500,
#                   by=    500 )
#  
#  cortes2  <- seq( from=  10000,
#                   to=   12000,
#                   by=    1500 )
#  
#  cortes3  <- seq( from=  13000,
#                   to=   17000,
#                   by=     1000 )
#  
#  cortes <- c(cortes1, cortes2,cortes3)

  
  cortes  <- seq( from= 15500,
                   to=  21000,
                   by=    500 )  
