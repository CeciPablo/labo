...
PARAM  <- list()
PARAM$experimento <- "TS9320_M06_US100_ST100"
...
dataset_input  <- paste0( "./", PARAM$exp_input, "/exp_FE9250_dataset.csv.gz" )
dataset  <- fread( dataset_input )


#creo la carpeta donde va el experimento
dir.create( paste0( "./exp/COLECTIVO/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp/COLECTIVO/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
