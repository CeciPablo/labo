...
semillas <- c(102191, 869587, 417227, 290923, 66617,66637,66647, 500009, 600011, 700001)

#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "COLECTIVO/ZZ9420_M10_US15_Semillas"
PARAM$exp_input  <- "COLECTIVO/HT9420_M10_US15_ST100"

for (q in semillas ){
  
  PARAM$submit <- paste0("ZZ9420_M10_US15_S",q)
  ...
  # Filtro los meses porque Training Stretegy tiene dos meses de mas
