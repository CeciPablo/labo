...
PARAM  <- list()
PARAM$experimento <- "TS9320_M17_US100_ST100_r7"
...
PARAM$train$training     <- c(201905:201912, 202011, 202012, 202101:202105)
...
PARAM$train$semilla_sampling  <- 734131
PARAM$train$semilla_under     <- 902389
