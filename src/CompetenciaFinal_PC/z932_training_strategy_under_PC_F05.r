...
PARAM  <- list()
PARAM$experimento <- "TS9320_M17_US060_ST100_r5"

PARAM$exp_input  <- "COMPfinal/FE9250_00"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c(201905:201912, 202011, 202012, 202101:202107)

PARAM$train$training     <- c(201905:201912, 202011, 202012, 202101:202107)
PARAM$train$validation   <- c(201905:201912, 202011, 202012, 202101:202107)
PARAM$train$testing      <- c(201905:201912, 202011, 202012, 202101:202107)
