...
<<<<<<< HEAD
  ...
  dataset[ , campo04 := as.integer( ctrx_quarter <14 & mcuentas_saldo>= -1256.1 & mcaja_ahorro>=2601.1 ) ] 
  dataset[ , campo05 := as.integer( ctrx_quarter>=14 & ( Visa_status>=8 | is.na(Visa_status) ) & ( Master_status>=8 | is.na(Master_status) ) ) ]
  dataset[ , campo06 := as.integer( ctrx_quarter>=14 & ( Visa_status>=8 | is.na(Visa_status) ) & ( Master_status <8 & !is.na(Master_status) ) ) ]
  dataset[ , campo07 := as.integer( ctrx_quarter>=14 & Visa_status <8 & !is.na(Visa_status) & ctrx_quarter <38 ) ]
  dataset[ , campo08 := as.integer( ctrx_quarter>=14 & Visa_status <8 & !is.na(Visa_status) & ctrx_quarter>=38 ) ]
  dataset[ , campo09 := mcaja_ahorro > 0 ]
  ...
  dataset[ , campo13 := ctrx_quarter <14 & Visa_mconsumototal < 5000 & Master_mconsumototal < 5000 & mcaja_ahorro < 10000 ] # este campo no existe en el dataset
  dataset[ , campo14 := ((cliente_antiguedad/(12*cliente_edad))/(100-18))]
  dataset[ , campo15 := (mcuenta_corriente_adicional+mcuenta_corriente+mprestamos_personales+mprestamos_prendarios+mprestamos_hipotecarios)/(mcuentas_saldo+mplazo_fijo_dolares+mplazo_fijo_pesos+minversion1_pesos+minversion1_dolares+ minversion2)]
  dataset[ , campo16 := (mcuenta_corriente_adicional+mcuenta_corriente+mprestamos_personales+mprestamos_prendarios+mprestamos_hipotecarios)/(mcuentas_saldo)]
