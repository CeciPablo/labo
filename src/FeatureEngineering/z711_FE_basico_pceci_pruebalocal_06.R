...
#setwd( "~/buckets/b1/" ) #PC_comentada para prueba local
setwd("/dmef") #PC_agregada para prueba local

#cargo el dataset
#dataset  <- fread( "competencia2_2022.csv") #PC_comentada para prueba local
dataset <- fread("./datasets/competencia2_2022.csv") #PC_agregada para prueba local

#creo la carpeta donde va el experimento
# FE  representa  Feature Engineering
#dir.create( "./exp/",  showWarnings = FALSE ) #PC_comentada para prueba local
