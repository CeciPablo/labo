...
hs <- makeParamSet( 
         ...
         makeNumericParam("min_gain_to_split", lower=   0.0  , upper=   15.0), #PC_Los Agrego para optimizar
         makeNumericParam("lambda_l1",         lower=   0.0  , upper=  1.0), #PC_Los Agrego para optimizar
         makeNumericParam("lambda_l2",         lower=   0.0  , upper=  1.0), #PC_Los Agrego para optimizar
...
PARAM$hyperparametertuning$semilla_azar  <- 100057  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
...
#                          max_depth=  -1,         # -1 significa no limitar,  por ahora lo dejo fijo
                          num_leaves = (2^(x$max_depth)/2), #PC_lo agrego para optimizar según indica documentación
